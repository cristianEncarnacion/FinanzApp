...
const ContactForm = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    emailjs
      .sendForm("your service", "your template", form, "your user")
      .then(() => {
  ...
  return (
    <div className="mb-10 mt-12">
      <p className="mb-6 text-lg text-center">
        Te gustaría personalizar tu FinancePro? Puedes contactarme a través de
        este formulario y te responderé lo antes posible. También para
        contrataciones.
      </p>
